...
Bookmark _bookmarkDeserialize(
  ...
  object.snippet = reader.readString(offsets[3]);
  return object;
}
...
extension BookmarkQueryFilter
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> pageEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'page',
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> pageGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> pageLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> pageBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension BookmarkQuerySortBy on QueryBuilder<Bookmark, Bookmark, QSortBy> {
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterSortBy> sortByPage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'page', Sort.asc);
    });
  }

  QueryBuilder<Bookmark, Bookmark, QAfterSortBy> sortByPageDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BookmarkQuerySortThenBy
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterSortBy> thenByPage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'page', Sort.asc);
    });
  }

  QueryBuilder<Bookmark, Bookmark, QAfterSortBy> thenByPageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'page', Sort.desc);
    });
  }
...
extension BookmarkQueryWhereDistinct
  ...
  QueryBuilder<Bookmark, Bookmark, QDistinct> distinctByPage() {
    return QueryBuilder.apply(this, (query) {
...
extension BookmarkQueryProperty
  ...
  QueryBuilder<Bookmark, int, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdAt');
    });
  }

  QueryBuilder<Bookmark, int, QQueryOperations> pageProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension GetReadingStateCollection on Isar {
  IsarCollection<ReadingState> get readingStates => this.collection();
}

const ReadingStateSchema = CollectionSchema(
  name: r'ReadingState',
  id: -4213986049042693251,
  properties: {
    r'bookId': PropertySchema(
      id: 0,
      name: r'bookId',
  ...
  estimateSize: _readingStateEstimateSize,
  serialize: _readingStateSerialize,
  deserialize: _readingStateDeserialize,
  deserializeProp: _readingStateDeserializeProp,
  idName: r'id',
  indexes: {
    r'bookId': IndexSchema(
      id: 3567540928881766442,
  ...
  links: {},
  embeddedSchemas: {},
  getId: _readingStateGetId,
  getLinks: _readingStateGetLinks,
  attach: _readingStateAttach,
  version: '3.1.0+1',
);

int _readingStateEstimateSize(
  ReadingState object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
...
void _readingStateSerialize(
  ...
  writer.writeLong(offsets[2], object.totalPages);
  writer.writeLong(offsets[3], object.updatedAt);
}

ReadingState _readingStateDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = ReadingState();
  object.bookId = reader.readString(offsets[0]);
  object.id = id;
  object.page = reader.readLong(offsets[1]);
  object.totalPages = reader.readLong(offsets[2]);
  object.updatedAt = reader.readLong(offsets[3]);
  return object;
}

P _readingStateDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _readingStateGetId(ReadingState object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _readingStateGetLinks(ReadingState object) {
  return [];
}

void _readingStateAttach(
    IsarCollection<dynamic> col, Id id, ReadingState object) {
  object.id = id;
}

extension ReadingStateByIndex on IsarCollection<ReadingState> {
  Future<ReadingState?> getByBookId(String bookId) {
    return getByIndex(r'bookId', [bookId]);
  }

  ReadingState? getByBookIdSync(String bookId) {
  ...
  Future<List<ReadingState?>> getAllByBookId(List<String> bookIdValues) {
    final values = bookIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'bookId', values);
  }

  List<ReadingState?> getAllByBookIdSync(List<String> bookIdValues) {
    final values = bookIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByBookId(ReadingState object) {
    return putByIndex(r'bookId', object);
  }

  Id putByBookIdSync(ReadingState object, {bool saveLinks = true}) {
    return putByIndexSync(r'bookId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByBookId(List<ReadingState> objects) {
    return putAllByIndex(r'bookId', objects);
  }

  List<Id> putAllByBookIdSync(List<ReadingState> objects,
      {bool saveLinks = true}) {
    return putAllByIndexSync(r'bookId', objects, saveLinks: saveLinks);
  }
}

extension ReadingStateQueryWhereSort
    on QueryBuilder<ReadingState, ReadingState, QWhere> {
  QueryBuilder<ReadingState, ReadingState, QAfterWhere> anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
  }
...
extension ReadingStateQueryWhere
    on QueryBuilder<ReadingState, ReadingState, QWhereClause> {
  QueryBuilder<ReadingState, ReadingState, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IdWhereClause.between(
        lower: id,
        upper: id,
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterWhereClause> idNotEqualTo(
      Id id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterWhereClause> idGreaterThan(
      Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.lessThan(upper: id, includeUpper: include),
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterWhereClause> bookIdEqualTo(
      String bookId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'bookId',
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterWhereClause> bookIdNotEqualTo(
      String bookId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ReadingStateQueryFilter
    on QueryBuilder<ReadingState, ReadingState, QFilterCondition> {
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition> bookIdEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition>
      bookIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition> bookIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition> bookIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition> idEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition> idGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition> idLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition> idBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition> pageEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'page',
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition> pageLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterFilterCondition> pageBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ReadingStateQueryObject
    on QueryBuilder<ReadingState, ReadingState, QFilterCondition> {}

extension ReadingStateQueryLinks
    on QueryBuilder<ReadingState, ReadingState, QFilterCondition> {}

extension ReadingStateQuerySortBy
    on QueryBuilder<ReadingState, ReadingState, QSortBy> {
  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> sortByBookId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bookId', Sort.asc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> sortByBookIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bookId', Sort.desc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> sortByPage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'page', Sort.asc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> sortByPageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'page', Sort.desc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> sortByTotalPages() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalPages', Sort.asc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy>
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> sortByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> sortByUpdatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ReadingStateQuerySortThenBy
    on QueryBuilder<ReadingState, ReadingState, QSortThenBy> {
  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> thenByBookId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bookId', Sort.asc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> thenByBookIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bookId', Sort.desc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.asc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> thenByIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id', Sort.desc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> thenByPage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'page', Sort.asc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> thenByPageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'page', Sort.desc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> thenByTotalPages() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalPages', Sort.asc);
    });
  }
  ...
  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> thenByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }

  QueryBuilder<ReadingState, ReadingState, QAfterSortBy> thenByUpdatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.desc);
    });
  }
...
extension ReadingStateQueryWhereDistinct
    on QueryBuilder<ReadingState, ReadingState, QDistinct> {
  QueryBuilder<ReadingState, ReadingState, QDistinct> distinctByBookId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'bookId', caseSensitive: caseSensitive);
    });
  ...
  QueryBuilder<ReadingState, ReadingState, QDistinct> distinctByPage() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'page');
    });
  }

  QueryBuilder<ReadingState, ReadingState, QDistinct> distinctByTotalPages() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'totalPages');
    });
  }

  QueryBuilder<ReadingState, ReadingState, QDistinct> distinctByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension ReadingStateQueryProperty
    on QueryBuilder<ReadingState, ReadingState, QQueryProperty> {
  QueryBuilder<ReadingState, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<ReadingState, String, QQueryOperations> bookIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'bookId');
    });
  }

  QueryBuilder<ReadingState, int, QQueryOperations> pageProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'page');
    });
  }

  QueryBuilder<ReadingState, int, QQueryOperations> totalPagesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'totalPages');
    });
  }

  QueryBuilder<ReadingState, int, QQueryOperations> updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
